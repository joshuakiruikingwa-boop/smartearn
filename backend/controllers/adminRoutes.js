...
const { getSettings, updateSettings, getSpinConfig, updateSpinConfig } = require('../controllers/adminSettingsController');
...
// Web interface routes to serve HTML views for admin modules
router.get('/users-page', (req, res) => {
    res.sendFile('adminusers.html', { root: adminDir });
});

router.get('/surveys-page', (req, res) => {
    res.sendFile('adminsurveys.html', { root: adminDir });
});

router.get('/videos-page', (req, res) => {
    res.sendFile('adminvideos.html', { root: adminDir });
});

router.get('/withdrawals-page', (req, res) => {
    res.sendFile('adminwithdrawals.html', { root: adminDir });
});

router.get('/payments-page', (req, res) => {
    res.sendFile('adminpayments.html', { root: adminDir });
});

router.get('/settings-page', (req, res) => {
    res.sendFile('adminsettings.html', { root: adminDir });
});
...
// Payment Management (Activations)
